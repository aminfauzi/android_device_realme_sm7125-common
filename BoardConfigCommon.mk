...
BOARD_CACHEIMAGE_PARTITION_SIZE := 100663296 #96MB
...
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := $(shell echo $$(($(BOARD_SUPER_PARTITION_SIZE) - 41943040))) # (BOARD_SUPER_PARTITION_SIZE - "reasonable overhead of 40 MiB")
...
## Reserved Sizes
BOARD_ODMIMAGE_PARTITION_RESERVED_SIZE := 524288000 #500MB
BOARD_VENDORIMAGE_PARTITION_RESERVED_SIZE := 524288000 #500MB
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 2147483648 # 2GB free for GApps
...
BOARD_FLASH_BLOCK_SIZE := 262144 #256KB
