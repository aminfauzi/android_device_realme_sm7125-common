...
BOARD_SUPER_PARTITION_SIZE := 8183087104 #~7.62GB
...
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := 8178892800   # slightly smaller than super
...
## Reserved Sizes (Dynamic)
SSI_PARTITIONS := system system_ext product
TREBLE_PARTITIONS := vendor odm

ifneq ($(filter true,$(WITH_GMS) $(WITH_GAPPS)),true)
$(foreach p,$(call to-upper,$(SSI_PARTITIONS)), \
    $(eval BOARD_$(p)IMAGE_EXTFS_INODE_COUNT := -1))

SSI_PARTITIONS_RESERVED_SIZE := 314572800   # 300MB
else
SSI_PARTITIONS_RESERVED_SIZE := 30720000    # 30MB
endif
